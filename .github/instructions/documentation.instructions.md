...
applyTo: ["**/*.md", "designdoc/**", "webapp/src/**", "webapp/app/**"]
---
...
- API エンドポイントや認証フローの変更 ➔ `designdoc/sequenceDiagram.mmd` を更新
- 画面操作や全体フローの変更 ➔ `designdoc/flowchart LR.mmd` を更新
- データモデル（DBやセッション等）の変更 ➔ `designdoc/erDiagram.mmd` を更新
