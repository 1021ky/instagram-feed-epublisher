    ...
    <section className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-sm border border-slate-200/80 max-w-xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8 w-full">
        <button
          ...
          className="w-full px-5 py-2.5 rounded-lg text-white font-medium text-xs sm:text-sm bg-gradient-to-r from-[#405DE6] via-[#C13584] to-[#E1306C] hover:opacity-95 transition flex items-center justify-center gap-2 shadow-xs cursor-pointer disabled:opacity-50 min-h-[40px]"
        >
        ...
        <button
          type="button"
          onClick={onDemo}
          className="w-full px-4 py-2.5 rounded-lg border border-slate-200 text-slate-600 hover:text-slate-900 font-medium text-xs sm:text-sm hover:bg-slate-50 transition flex items-center justify-center gap-1.5 cursor-pointer min-h-[40px]"
        >
          <span>デモを体験する</span>
