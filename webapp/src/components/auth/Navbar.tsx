    ...
    <nav className="navbar">
      <div className="navbar__brand">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-amber-500 via-rose-500 to-purple-600 flex items-center justify-center text-white shadow-2xs">
          ...
          <span className="text-xl font-bold tracking-tight text-slate-900">FeedsToBook</span>
        </div>
      </div>
